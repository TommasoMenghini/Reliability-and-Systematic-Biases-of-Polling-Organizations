...
This document shows the process to obtain up to the election day estimates of voters'intentions using the Kalman filter on the polling time series. The analysis closely mirrors the implementation in the R script [filter_results.R](R/filter_results.R).
